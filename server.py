...
# Enable debug logging (helps with MCP protocol issues)
logging.basicConfig(level=logging.DEBUG)

# Minimal OpenAPI spec for JSONPlaceholder
openapi_spec = {
    "openapi": "3.0.0",
...
# Let FastMCP manage the client using just base_url
...
async def root(_: Request) -> JSONResponse:
    return JSONResponse(
        {"status": "ok", "mcp_endpoint": "/mcp", "message": "Welcome to JSONPlaceholder MCP!"}
    )
